  ...
  <br>
       <div class="container-fluid px-4">
         <div class="card mt-4">
           ...
           <div class="card-body">
            <form method="POST" action="{{url('update_data',$data->id)}}">
                @csrf
                <div class="mb-3">
                    <label>name</label>
                    <input type="text" name="name" class="form-control" value="{{ $data->name }}" required autocomplete="name" autofocus>

                </div>
                <div class="mb-3">
                    <label>email</label>
                    <input type="text" name="email" class="form-control" value="{{$data->email }}" required autocomplete="email">
                </div>
                <div class="mb-3">
