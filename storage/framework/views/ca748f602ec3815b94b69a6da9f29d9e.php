...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a href="<?php echo e(url('alogin')); ?>"class="text-body pr-3">Admin Login</a>
        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    <a href="<?php echo e(url('w')); ?>" class="nav-item nav-link active">Home</a>
    ...
    <?php echo $__env->make('includes.slide', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('includes.cars', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        
    </body>
</html>
<?php /**PATH C:\z\xampp\htdocs\rentalcar\resources\views/welcome.blade.php ENDPATH**/ ?>