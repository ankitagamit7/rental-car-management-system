...
<div class="container-fluid bg-dark py-3 px-lg-5 d-none d-lg-block">
            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="<?php echo e(url('w')); ?>" class="nav-item nav-link">Home</a>
   ...
   <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            ...
            <h6 class="text-uppercase text-body m-0">Cantact</h6>
        </div>
    </div>
    <!-- Page Header Start -->
            ...
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="store_datasc" method="post">
                        <?php echo csrf_field(); ?>  
                            <div class="row">
...
</html><?php /**PATH C:\z\xampp\htdocs\rentalcar\resources\views/contact.blade.php ENDPATH**/ ?>