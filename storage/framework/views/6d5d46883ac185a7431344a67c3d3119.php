            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        <img class="img-fluid mb-4" src="<?php echo e($post->car_img); ?>" alt="">
                        <h4 class="text-uppercase mb-4"><?php echo e($post->car_name); ?></h4>
                        ...
                        <a class="btn btn-primary px-3" href=""><i style="font-size:16px" class="fa">&#xf156;</i>99.00/Day</a>
                    </div>
                </div>
...
<?php /**PATH C:\z\xampp\htdocs\rentalcar\resources\views/cars.blade.php ENDPATH**/ ?>